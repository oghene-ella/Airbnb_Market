...
<ol>
  <li>The average price per night for an Airbnb listing in NYC is $141.82.<br>I was able to do that by filtering the free listing (that is by removing the ones that had $0) and calculating the average of the remaining ones in the column.</li>
